...
read o
	case $o in
        ...
        2)  git clone -b cm-14.1 https://github.com/PineDevelopment/android_device_sony_pine device/sony/pine;;
        3)  git clone -b cm-14.1 https://github.com/PineDevelopment/android_kernel_sony_pine kernel/sony/pine;;
        4)  git clone -b cm-14.1 https://github.com/PineDevelopment/android_vendor_sony_pine vendor/sony/pine;;
